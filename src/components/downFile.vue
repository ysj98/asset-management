<!--
 * @Description: 展示一级组织机构 下载文件模板，上传文件
  /*
  event
  $emit('down') 下载事件
  $emit(''upload') 上传事件
    ...
    <div class="upLoad-main">
      <div class="upLoad-left">
        <div class="r-nav">
          ...
          <a-select showSearch style="width:350px" :options="$addTitle(organOptions)" @change="changeTree"
            :filterOption="filterOption" placeholder="请选择组织机构"></a-select>
        </div>
