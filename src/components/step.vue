      ...
      <div class="detail-item" v-for="(item, index) in stepList" :key="index + 'detail-item'">
        ...
        <div class="desc">
          ...
          <div class="operate" v-if="item.operation.length">
            <span v-for="(operateItem, i) in item.operation" :key="i" @click="handleClick(operateItem.funcName, operateItem)">
              <span :key="i + 'line'" class="line"></span>
              <template v-if="operateItem.iconOption">
                <SG-Icon :type="operateItem.iconOption.type" :size="operateItem.iconOption.size" :color="operateItem.iconOption.color"> </SG-Icon>
              </template>
