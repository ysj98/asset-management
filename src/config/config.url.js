...
export const basics = {
  ...
  // 建筑形态
  queryChildNodesById:
    "/basic-data-api/rest-api/v1/professionType/queryChildNodesById",
  // 查询省列表
  queryProvinceList: "/basic-data-api/rest-api/v1/regionApi/queryProvinceList",
  /* 查询市、区、街道办 */
  queryCityAndAreaList:
    "/basic-data-api/rest-api/v1/regionApi/queryRegionByPId",
  // 按照一级物业公司查询楼栋列表
  ...
  // 请求楼层
  queryFloorListByPosId:
    "/basic-data-api/rest-api/v1/floorApi/queryFloorListByPosId",
  ...
  // 根据组织机构查询岗位
  queryPostNewPageList:
    "/basic-data-api/rest-api/v1/postmanageApi/queryPostNewPageList",
  // 组织机构请求项目
  queryCommunityListByOrganId:
    "/basic-data-api/rest-api/v1/community/queryCommunityListByOrganId",
  // 土地信息导入文档
...
export const assets = {
  ...
  assetRegister: {
    ...
    // 资产登记明细列表-不分页
    getRegisterOrderDetailsById:
      "/ams/registerOrder/getRegisterOrderDetailsById",
    // 资产登记-详情明细统计
    getRegisterOrderDetailsStatistics:
      "/ams/registerOrder/getRegisterOrderDetailsStatistics",
    // 资产登记-读取excel模板文件
    ...
    // 资产登记-附属配套-分页查询列表
    getListPageByRegisterOrderId:
      "/ams/subsidiaryMatching/getListPageByRegisterOrderId",
    // 资产登记一览表-附属配套-分页查询列表
    getMatchingListByAssetIdPage:
      "/ams/subsidiaryMatching/getMatchingListByAssetIdPage",
    // 附属配套-新增/修改保存(资产登记版)
    ...
    getRegisterOrderDetailsPageByIdList:
      "/ams/registerOrder/getRegisterOrderDetailsPageByIdList",
    // 批量更新（导入）
  ...
  assetClassSet: {
    ...
    getFeeTypeList2:
      "/charging-lease-api/rest-api/v1/feeItemType/queryFirstOrganFeeItemTypeList",
    // 资产分类设置-修改资产分类
    ...
    getEquipmentListByUpEquipmentId:
      "/equipment-openapi/equipment/getEquipmentListByUpEquipmentId",
    // 3.1.5根据设备分类ID查询设备分类台账属性(不分页)
    getInfoAttrListByEquipmentId:
      "/equipment-openapi/equipment/getInfoAttrListByEquipmentId",
    // 删除设施设备分类
  ...
  organView: {
    ...
    viewGetAssetHouseListForOrgan:
      "/ams/asset-house/viewGetAssetHouseListForOrgan",
    // 组织机构视图详情表头统计
    viewGetAssetHouseStatisticsForOrgan:
      "/ams/asset-house/viewGetAssetHouseStatisticsForOrgan",
  },
  // 房屋台账 - 资产视图
  assetView: {
    // 房屋资产信息查询
    ...
    // 资产视图-运营信息-合同信息（分页）
    assetOperationContractInfo:
      "/ams/operationContract/assetOperationContractInfo",
    // // 资产视图-运营信息-运营收入（分页）
    // assetOperationExpenseInfo: '/ams/operationContract/assetOperationExpenseInfo',
    // 资产视图-运营信息-运营收入（返回参数）
    assetOperationExpenseParam:
      "/ams/operationContract/assetOperationExpenseParam",
...
export const building = {
  ...
  queryHouseDetailById:
    "/basic-data-api/rest-api/v1/ams/houseApi/queryHouseDetailById",
  // 修改房屋状态
  updateHouseStatus:
  ...
  positionSelectAsyn:
    "/basic-data-api/rest-api/v1/ams/positionApi/positionSelectAsyn",
  // 查询楼栋下可挂位置类型 位置管理-位置树查询 GET
  queryBellowPositionType:
    "/basic-data-api/rest-api/v1/positionApi/queryBellowPositionType",
  // 下载房屋资料模板-（房间信息导入）
  downLoadExcel:
    "/basic-data-batch-api/rest-api/v1/ams/houseFileApi/downLoadExcel",
  // 导入房间资料
  importExcel: "/basic-data-batch-api/rest-api/v1/ams/houseFileApi/importExcel",
  // 房间批量更新
  acctHouseCodeImport:
    "/basic-data-batch-api/rest-api/v1/ams/houseFileApi/acctHouseCodeImport",
  // 房屋导出
  exportHouse: "/basic-data-batch-api/rest-api/v1/ams/houseFileApi/exportHouse",
  // 下载楼栋导入模板
  buildingDownLoadExcel:
    "/basic-data-batch-api/rest-api/v1/ams/buildFileApi/downLoadExcel",
  // 楼栋批量导入
  buildImportExcel:
  ...
  // 车场 新增
  parkApiInsert:
    "/car-parking-api/rest-api/v1/parkingPlaceRestApiController/addParkingPlace.json",
  // 车场 删除
  parkApiDelete:
  ...
  // 区域 新增
  addParkingPlaceArea:
    "/car-parking-api/rest-api/v1/parkingPlaceRestApiController/addParkingPlaceArea.json",
  // 区域 修改
  editParkingPlaceArea:
    "/car-parking-api/rest-api/v1/parkingPlaceRestApiController/updateParkingPlaceArea.json",
  // 区域 列表
  getParkingPlaceAreasByPlaceId:
    "/car-parking-api/rest-api/v1/parkingPlaceRestApiController/getParkingPlaceAreasByPlaceId.json",
  // 车场 编辑
  parkApiEdit:
    "/car-parking-api/rest-api/v1/parkingPlaceRestApiController/updateParkingPlace.json",
  // 车场 详情
  parkApiDetail:
    "/car-parking-api/rest-api/v1/parkingPlaceRestApiController/getParkingPlaceById.json",
  // 车位 分页查询
  stallApiPageList:
    "/car-parking-api/rest-api/v1/parkingPlaceApiController/parkingPlaceResult.json",
  // 车位 新增
  stallApiInsert:
    "/car-parking-api/rest-api/v1/parkingPlaceApiController/saveParkingPlace.json",
  // 车位 删除
  stallApiDelete:
    "/car-parking-api/rest-api/v1/parkingPlaceApiController/deleteParkingPlace.json",
  // 车位 编辑
  stallApiEdit:
    "/car-parking-api/rest-api/v1/parkingPlaceApiController/updateParkingPlace.json",
  // 车位 详情
  stallApiDetail:
    "/car-parking-api/rest-api/v1/parkingPlaceApiController/parkingPlaceDetail.json",
  // 车位 导出
  stallApiExport:
  ...
  getEquipmentSupplierListByOrganId:
    "/equipment-openapi/equipmentSupplier/getEquipmentSupplierListByOrganId",
  // 根据组织机构id查询分类编码表
  getEquipmentCodeList: "/equipment-openapi/equipment/getEquipmentCodeList",
  // 根据组织机构id查询分类编码表
  getEquipmentListByUpEquipmentId:
  ...
  getInfoAttrListByEquipmentId:
    "/equipment-openapi/equipment/getInfoAttrListByEquipmentId",
  // 根据communityId查询位置
  getEquipmentInstListByTopOrganId:
    "/equipment-openapi/common/getPositionListByCommunityId",
  // 根据 communityId 查询 organId
  queryOrganIdByCommunityId:
    "/equipment-openapi/common/queryOrganIdByCommunityId",
  // 根据CommunityID查询位置列表
  positionSelectByCommunityID:
    "/basic-data-api/rest-api/v1/positionApi/positionSelectByID",
...
export const worthRegister = {
  // 价值登记查询(分页)
  queryValueRegisterPageList:
    "/ams/assetValueRegister/queryValueRegisterPageList",
  // 价值登记状态操作
  updateRegisterStatus: "/ams/assetValueRegister/updateRegisterStatus",
  // 价值登记记录查询(分页)
  queryValueRegisterRecordList:
    "/ams/assetValueRegister/queryValueRegisterRecordList",
  // 价值登记详情
  queryValueRegisterDetail: "/ams/assetValueRegister/queryValueRegisterDetail",
  // 价值登记资产查询
  queryValueRegisterRelList:
    "/ams/assetValueRegister/queryValueRegisterRelList",
  // 价值登记资产查询(分页)
  queryValueRegisterRelPageList:
    "/ams/assetValueRegister/queryValueRegisterRelPageList",
  // 新增价值登记
  ...
  // 价值登记查询(汇总)
  queryValueRegisterPageListSum:
    "/ams/assetValueRegister/queryValueRegisterPageListSum",
  // 价值登记导入
...
export const dispose = {
  // 资产处置一览表-主列表查询(分页)
  getDetailAndDisposeListPage:
    "/ams/disposeRegister/getDetailAndDisposeListPage",
  // 资产处置一览表-统计
  getDetailAndDisposeListStat:
    "/ams/disposeRegister/getDetailAndDisposeListStat",
...
export const inventoryManagement = {
  ...
  inventoryPerform: {
    ...
    // 盘盈资产删除
    assetCheckInstDeleteByCheckResult:
      "/ams/assetCheckInst/deleteByCheckResult",
    // 资产盘点提交
...
export const reportManage = {
  ...
  // 查询资产折旧(分页)
  queryAssetDeprecitionPageList:
    "/ams/reportdata/queryAssetDeprecitionPageList",
  // 查询资产收入(分页)
...
export const land = {
  ...
  // 土地台账--组织机构视图详情资产概况汇总
  organViewProjectDetailTotal:
    "/ams/assetLand/view/asset/organViewProjectDetailTotal",
  // 土地台账--组织机构视图详情资产概况列表
...
export const delivery = {
  ...
  // 资产交付记录导出
  deliveryExportChangeScheduleList:
    "/ams/deliveryDetail/exportChangeScheduleList",
  // 资产交付记录汇总
...
export const useManage = {
  ...
  // 巡查记录-新增编辑保存
  addOrUpdateInspectionRecord:
    "/ams/inspectionTaskRecord/addOrUpdateInspectionRecord",
  // 巡查记录-导出详情
  ...
  getInspectionCheckItemPageList:
    "/ams/inspectionCheckItem/getInspectionCheckItemPageList",
  // 巡查记录-不分页查询检查项列表
  getInspectionCheckItemList:
    "/ams/inspectionCheckItem/getInspectionCheckItemList",
  // 巡查记录-删除巡查记录
