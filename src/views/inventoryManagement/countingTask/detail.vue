 ...
 * @LastEditTime: 2020-10-10 11:04:46
...
<template>
  <div class="countingTaskDetail">
    ...
    <div class="countingTaskDetail-nav">
      ...
      <div class="countingTaskDetail-obj">
        <div class="table-layout-fixed table-border">
          <a-table :loading="loading" :columns="InventoryReportColumns" :dataSource="inventoryReportData" size="middle" :pagination="false">
...
export default {
  ...
  watch: {
    $route() {
      ...
      let routeData = false;
      if (this.$route.path === '/inventoryManagement/countingTask/detail' || this.$route.path === '/inventoryPlan/detail/taskDetail') {
        routeData = true;
      }
      if (routeData && detail) {
