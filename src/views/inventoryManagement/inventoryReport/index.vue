    ...
    <SG-SearchContainer background="white">
      <div slot="headBtns">
        <SG-Button
          ...
          v-power="ASSET_MANAGEMENT.ASSET_INVENTORY_REPORT_EXPORT"
          @click="handleExport"
          >导出</SG-Button
        >
        <SG-Button icon="plus" type="primary" @click="newInventoryReport" v-power="ASSET_MANAGEMENT.ASSET_INVENTORY_REPORT_NEW"
          >新建盘点报告</SG-Button
        >
      </div>
      <div slot="headRight">
      ...
      <a-table :columns="columns" :dataSource="dataSource" size="middle" :pagination="false">
        <template slot="operation" slot-scope="text, record">
          <a
            ...
            v-power="ASSET_MANAGEMENT.ASSET_INVENTORY__REPORT_AUDIT"
            >审核</a
          >
          <a
            class="operation-btn"
            ...
            v-power="ASSET_MANAGEMENT.ASSET_INVENTORY_REPORT_REVERSE_AUDIT"
            >反审核</a
          >
          <a
            class="operation-btn"
            ...
            v-power="ASSET_MANAGEMENT.ASSET_INVENTORY_REPORT_EDIT"
            >编辑</a
          >
          <a
            class="operation-btn"
            v-show="+record.approvalStatus === 0 || +record.approvalStatus === 3"
            @click="handleStatus(record, 4)"
            v-power="ASSET_MANAGEMENT.ASSET_INVENTORY_REPORT_DELETE"
            >删除</a
          >
  ...
  methods: {
    ...
    newInventoryReport() {
      this.$router.push({
        ...
        query: { pageType: 'new', organId: this.organId, organName: this.organName },
      });
    },
    ...
    handleOperation(pageType, record) {
      this.$router.push({
        path: '/inventoryManagement/inventoryReport/' + pageType,
        query: { pageType: pageType, reportId: record.reportId, organId: this.organId, organName: this.organName },
      });
    },
    // 点击查询
    queryClick() {
