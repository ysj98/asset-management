    ...
    <a-form :form="form" @submit="handleSubmit">
        ...
        <div class="edit-box-content">
          <div class="edit-box-content-item">
            <div class="label-name-box" :class="{ required: editable }">
              <span class="label-name" :class="{ 'label-space-between': editable }">处理方式<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-select
                showSearch
                ...
                v-decorator="['handleWay', { rules: [{ required: true, message: '请选择处理方式' }], initialValue: detail.handleWay }]"
                v-if="editable"
              ></a-select>
          ...
          <div class="edit-box-content-item" v-show="!editable">
            <div class="label-name-box">
              <span class="label-name">处理人<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item" v-show="!editable">
            <div class="label-name-box">
              <span class="label-name">处理时间<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item total-width">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">处理说明<i></i></span><span>：</span>
            </div>
            <a-form-item class="label-value">
              <a-textarea
                ...
                :rows="3"
                v-if="editable"
                v-decorator="['handleRemark', { rules: [{ validator: validateRemark }], initialValue: detail.handleRemark }]"
              ></a-textarea>
      ...
      <div class="edit-box">
        ...
        <div class="edit-box-content">
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">资产编码<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">资产名称<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">所属机构<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">资产项目<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">资产类型<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">资产分类<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">资产状态<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">资产位置<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">异常编号<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">盘点任务<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">异常类型<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">异常说明<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name">处理建议<i></i></span><span>：</span>
            </div>
            <a-form-item>
          ...
          <div class="edit-box-content-item total-width">
            <div class="label-name-box">
              <span class="label-name">图片<i></i></span><span>：</span>
            </div>
            <a-form-item class="label-value">
              <UploadFile type="all" :show="true" v-model="exceptionInfo.attachment" />
