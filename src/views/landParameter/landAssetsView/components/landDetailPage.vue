...
<template>
  <div class="asset_view">
    ...
    <!--其它信息部分-->
    <other-info-part v-if="assetLandId" :assetLandId="assetLandId" :assetId="assetId" :transferOperationArea="transferOperationArea" :transferOperationTime="transferOperationTime"/>
  </div>
</template>
