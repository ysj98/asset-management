  ...
  <a-spin :spinning="spinning">
    <div class="particulars">
      <div class="particulars-nav">
        ...
        <SG-Button size="small" style="float: right" type="primary" @click="downloadFn">导出巡查记录表</SG-Button>
        <div class="particulars-obj">
          <a-row class="playground-row">
            <a-col class="playground-col" :span="8" v-for="(item, index) in basicData" :key="index">
      ...
      <div class="particulars-nav">
        ...
        <div class="particulars-obj">
          <a-row class="playground-row">
            <a-col class="playground-col" :span="8" v-for="(item, index) in resultsData" :key="index">
              {{ item.name }}：{{ basicObj[item.key] || '--' }}
            </a-col>
...
export default {
  ...
  mounted() {
    ...
    this.spinning = true;
    Promise.all([this.query(), this.getInspectionCheckItemPageList()]).then((res) => {
      this.spinning = false;
    });
  },
};
