    ...
    <div class="tab-container">
      ...
      <div class="tab-nav">
        <div class="table-border table-layout-fixed">
          <a-table :rowSelection="rowSelection" :loading="loading" :columns="columns" :dataSource="dataSource" size="middle" :pagination="false">
          </a-table>
        ...
        if (Number(res.data.code) === 0) {
          ...
          if (data) {
            ...
            data.forEach((element, index) => {
              ...
              (element.informant = undefined), (element.informantOpt = []);
            });
