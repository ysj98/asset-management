...
<template>
  <div class="delivery-newEditor">
    <div class="delivery-newEditor-nav">
          ...
          <a-col class="playground-col" :span="8">
            <a-form-item :colon="false" v-bind="formItemLayout">
              ...
              <a-select
                ...
                v-decorator="[
                  'inspectionType',
                  { rules: [{ required: true, message: '请选择资产类型' }], initialValue: newEditSingleData.inspectionType },
                ]"
                :allowClear="false"
          ...
          <a-col class="playground-col" :span="8">
            <a-form-item :colon="false" v-bind="formItemLayout">
              ...
              <a-date-picker
                ...
                v-decorator="[
                  'inspectionDate',
                  { rules: [{ required: true, message: '请选择计划巡查日期' }], initialValue: newEditSingleData.inspectionDate },
                ]"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col class="playground-col" :span="8">
            <a-form-item :colon="false" v-bind="formItemLayout">
              ...
              <a-select
                ...
                v-decorator="[
                  'inspectionStatus',
                  { rules: [{ required: true, message: '请选择巡检状态' }], initialValue: newEditSingleData.inspectionStatus },
                ]"
                :allowClear="false"
          ...
          <a-col class="playground-col" :span="8">
            <a-form-item :colon="false" v-bind="formItemLayout">
              ...
              <a-input
                ...
                :style="allWidth"
                :disabled="true"
                v-decorator="['selectObj', { rules: [], initialValue: selectObj.assetCode || '--' }]"
              />
            </a-form-item>
          </a-col>
          <a-col class="playground-col" :span="8">
            <a-form-item :colon="false" v-bind="formItemLayout">
              ...
              <a-input
                ...
                :style="allWidth"
                :disabled="true"
                v-decorator="['assetCategoryName', { rules: [], initialValue: selectObj.assetCategoryName || '--' }]"
              />
            </a-form-item>
          </a-col>
          <a-col class="playground-col" :span="8">
            <a-form-item :colon="false" v-bind="formItemLayout">
              ...
              <a-textarea
                ...
                :style="allWidth"
                :disabled="true"
                v-decorator="['address', { rules: [], initialValue: selectObj.address || '--' }]"
              />
            </a-form-item>
          </a-col>
        </a-form>
          ...
          <a-form :form="form">
              ...
              <a-form-item :colon="false" v-bind="formItemLayout">
                ...
                <a-date-picker
                  ...
                  v-decorator="[
                    ...
                    { rules: [{ required: false, message: '请选择实际巡查日期' }], initialValue: newEditSingleData.actualInspectionDate },
                  ]"
                />
              </a-form-item>
            </a-col>
            <a-col class="playground-col" :span="24">
              <a-form-item :colon="false" v-bind="formItemTextarea">
                ...
                <a-textarea
                  placeholder="请输入巡查问题描述"
                  :style="widthBox"
                  :autosize="{ minRows: 2, maxRows: 4 }"
                  v-decorator="[
                    'problemDescription',
                    {
                      rules: [{ required: false, max: 200, message: '请输入巡查问题描述(不超过200字符)' }],
                      initialValue: newEditSingleData.problemDescription,
                    },
                  ]"
                />
              </a-form-item>
            ...
            <a-col class="playground-col" :span="24">
              <a-form-item :colon="false" v-bind="formItemTextarea">
                ...
                <a-textarea
                  placeholder="请输入现场处理措施"
                  :style="widthBox"
                  :autosize="{ minRows: 2, maxRows: 4 }"
                  v-decorator="[
                    'sceneHandleMeasure',
                    {
                      rules: [{ required: false, max: 200, message: '请输入现场处理措施(不超过200字符)' }],
                      initialValue: newEditSingleData.sceneHandleMeasure,
                    },
                  ]"
                />
              </a-form-item>
      ...
      <div class="tab-nav" v-show="newEditSingleData.inspectionStatus + '' === '1'">
        ...
        <div class="table-layout-fixed detail-table ml40 mt30">
          <a-table :scroll="{ y: 450 }" :columns="columns" :dataSource="tableData" size="middle" :pagination="false">
    ...
    <!-- 选择资产 -->
    <RadioAssetModal
      v-if="newEditSingleData.projectId && newEditSingleData.assetType"
      :key="`${newEditSingleData.projectId + newEditSingleData.assetType}`"
      :selectObj="selectObj"
      :assetTypeDataTemp="assetTypeData"
      :projectDataTemp="projectIdData"
      :projectIdTemp="newEditSingleData.projectId"
      :assetTypeTemp="newEditSingleData.assetType"
      ref="radioAssetModal"
      :organId="organId"
      :organName="organName"
      queryType="5"
    ...
    <!-- 选人 -->
    <SelectStaffOrPost
      ref="selectStaffOrPost"
      :selectType="selectType"
      @change="changeSelectStaffOrPost"
      :selectOptList="newEditSingleData.userIdList"
    />
  </div>
</template>
