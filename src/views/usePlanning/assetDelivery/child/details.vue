  ...
  <a-spin :spinning="spinning">
    <div class="particulars">
      <div class="particulars-nav">
        ...
        <div class="particulars-obj">
          <a-row class="playground-row">
            <a-col class="playground-col" :span="item.key === 'remark' ? 24 : 8" v-for="(item, index) in basicData" :key="index">
      ...
      <div class="particulars-nav">
        ...
        <div class="particulars-obj">
          <div class="particulars-t">
            交付资产数量：{{ assetChangeCount || '0' }}个<span v-if="!isSelectedEquipment">，合计交付面积：{{ deliveryArea || '0' }}㎡</span>
          </div>
          <div class="table-layout-fixed table-border">
            <a-table :loading="loading" :columns="columnsCom" :dataSource="tableData" size="middle" :pagination="false"></a-table>
            <SG-FooterPagination
...
export default {
  ...
  mounted() {
    ...
    this.spinning = true;
    Promise.all([this.query(), this.getDeliveryDetailListPage(), this.getDeliveryDetailListStatistics(), this.attachment()]).then((res) => {
      this.spinning = false;
    });
  },
};
