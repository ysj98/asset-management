...
<template>
  <div class="edit_task">
    ...
    <a-row :gutter="8" style="margin: 10px 0 10px 26px">
      <a-col :span="4">
        <SG-Button icon="plus" type="primary" @click="handleAdd" style="margin-right: 10px" v-power="ASSET_MANAGEMENT.RM_TASK_NEW"
          >新建呈报任务</SG-Button
        >
        <!--二期开发-->
  ...
  data() {
    return {
      ...
      tableObj: {
        dataSource: [],
        loading: false,
        scroll: { x: 1600, y: 'calc(100vh - 385px)' },
        pagination: false,
        rowKey: 'reportTaskId',
        columns: [
          ...
          { title: '任务状态', dataIndex: 'taskStatusName', fixed: 'right', width: 100 },
