...
<template>
  <div class="particulars">
    ...
    <div class="particulars-nav">
      ...
      <div class="particulars-obj">
				<a-row class="playground-row">
          <a-col class="playground-col" :span="6">实施频次：{{particularsData.registerName || '--'}}</a-col>
					<a-col class="playground-col" :span="6">任务开始时间：{{particularsData.registerName || '--'}}</a-col>
					<a-col class="playground-col" :span="6">任务执行期限：{{particularsData.registerName || '--'}}</a-col>
					<a-col class="playground-col" :span="6">提前生成任务时间：{{particularsData.registerName || '--'}}</a-col>
				</a-row>
        <div class="table-layout-fixed table-border">
          <a-table
            :loading="loading"
