  ...
  <div class="assetsRegistration">
    <SG-SearchContainer size="fold" background="white" v-model="toggle" @input="searchContainerFn">
      ...
      <div slot="form" class="formCon">
        ...
        >
          <a-select-option :title="item.name" v-for="(item, index) in reportBillIdData" :key="index" :value="item.value">{{
            item.name
          }}</a-select-option>
        </a-select>
  ...
  data() {
    return {
      numList: [
        ...
        { title: '未完成', key: 'undone', value: 0, bgColor: '#4BD288' },
