...
<template>
  <div class="assetsRegistration">
    <SG-SearchContainer size="fold" background="white" v-model="toggle" @input="searchContainerFn">
      <div slot="headBtns">
        <SG-Button v-if="$power.has(ASSET_MANAGEMENT.ASSET_DEPRECIATION_EXPORT)" @click="openExport" type="primary"
    ...
    <a-table :loading="loading" :scroll="{ x: 2500, y: scrollHeight }" :columns="columns" :dataSource="tableData" size="middle" :pagination="false">
  ...
  methods: {
    ...
    openExport() {
      ...
      this.$api.reportManage
        .exportAssetDeprecitionList(obj)
        .then((res) => {
