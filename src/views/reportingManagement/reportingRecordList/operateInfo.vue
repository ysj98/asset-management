  ...
  <div>
    <div class="pb70">
      <SearchContainer v-model="toggle" :contentStyle="{ paddingTop: toggle ? '16px' : 0 }">
        <div slot="headerBtns">
          <SG-Button v-if="$power.has(ASSET_MANAGEMENT.ASSET_OPERATING_EXPORT)" @click="openExport" type="primary"
        ...
        <div slot="contentForm" class="search-content-box">
          <div class="search-from-box">
            ...
            />
            <!-- 合同编号 -->
            <a-input :maxLength="60" placeholder="请输入合同编号" v-model="queryCondition.contractCode" :style="allWidth" />
            <!-- 客户名称 -->
            <a-input :maxLength="60" placeholder="请输入客户名称" v-model="queryCondition.customerName" :style="allWidth" />
            <!-- 资源名称 -->
            <a-input :maxLength="60" placeholder="请输入资源名称" v-model="queryCondition.resourceName" :style="allWidth" />
          </div>
