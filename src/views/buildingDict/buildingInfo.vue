  ...
  <div class="buildingInfo-page" ref="buildingInfo">
    ...
    <div class="tree-box">
      ...
      <div class="page">
        ...
        <a-select default-value="10" class="select" @change="handleChange">
...
export default {
  ...
  computed: {
    showCreateBuild() {
      return (this.activeType === '0' && this.createType === '') || (this.activeType === '-2' && this.createType === 'build');
    },
    showCreateUnit() {
      return (this.activeType === '1' && this.createType === '') || (this.activeType === '0' && this.createType === 'unit');
    },
    showCreateFloor() {
      return (
    ...
    showCreateFloorBtn() {
      return (
        ((this.activeType === '0' && ['0', '2'].includes(this.childNodeType)) || this.activeType === '1') &&
