  ...
  <div class="buildingInfo-page" ref="buildingInfo">
    ...
    <div class="tree-box">
     ...
     <div class="create-btn">
       ...
       <div>
         <SG-Button v-power="ASSET_MANAGEMENT.ASSET_FLOOR_ADD"  v-if="showCreateFloorBtn" @click="createPage('floor')" type="primary" class="fr tree-btn" weaken>新增楼层</SG-Button>
         <SG-Button v-power="ASSET_MANAGEMENT.ASSET_UNIT_ADD"  v-if="showCreateUnitBtn" :class="[childNodeType==='0'&&'mr5']" @click="createPage('unit')" type="primary" class="fr tree-btn" weaken>新增单元</SG-Button>
         <SG-Button v-power="ASSET_MANAGEMENT.ASSET_BUILD_ADD" v-if="showCreateBuildBtn" @click="createPage('build')" type="primary" class="fr tree-btn" weaken>新增楼栋</SG-Button>
       </div>
     </div>
