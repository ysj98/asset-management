            ...
            <a-row>
              ...
              <a-col :span="8">
                <a-form-item label="土地名称" v-bind="formItemLayout">
                  <a-input
                    :style="allWidth"
                    :maxLength="30"
                    v-decorator="['blankName', {initialValue: '' || undefined, rules: [{required: true, whitespace: true, message: '请输入土地名称'}]}]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item label="土地编码" v-bind="formItemLayout">
                  <a-input
                    :style="allWidth"
                    :maxLength="30"
                    v-decorator="['blankCode', {initialValue: '' || undefined, rules: [{required: true, whitespace: true, message: '请输入土地编码'}]}]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
              ...
              <a-col :span="8">
                <a-form-item label="土地面积(㎡)" v-bind="formItemLayout">
                  <a-input-number
                    ...
                    :min="0"
                    :style="allWidth"
                    v-decorator="['buildArea', {rules: [{required: true, message: '请输入土地面积'}]}]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item label="宗地号" v-bind="formItemLayout">
                  <a-input
                    :style="allWidth"
                    :maxLength="30"
                    v-decorator="['theNo', {rules: [{required: true, whitespace: true, message: '请输入宗地号'}]}]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="24">
                <a-form-item label="地理位置" v-bind="formItemLayout2">
                  <div class="address-box">
                    <a-select
                      ...
                      :filterOption="filterOption"
                      notFoundContent="没有查询到数据"
                      v-decorator="['province', {rules: [{required: true, message: '请选择省'}, {validator: validateAddress}]}]"
                    />
                    <a-select
                      :style="allWidth1"
                      placeholder="市"
              ...
              <a-col :span="8">
                <a-form-item label="经纬度" v-bind="formItemLayout">
                  <a-input
                    :style="allWidth"
                    v-decorator="['lngAndlat', {rules: [{required: true, whitespace: true, message: '请选择或输入经纬度'}]}]"
                  >
              ...
              <a-col :span="8">
                <a-form-item label="土地类型" v-bind="formItemLayout">
                  <a-select
                    ...
                    :filterOption="filterOption"
                    notFoundContent="没有查询到数据"
                    v-decorator="['landType', {rules: [{required: true, whitespace: true, message: '请选择土地类型'}]}]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item label="土地用途分类" v-bind="formItemLayout">
                  <a-select
                    ...
                    :filterOption="filterOption"
                    notFoundContent="没有查询到数据"
                    v-decorator="['landuseType', {rules: [{required: true, whitespace: true, message: '请选择土地用途分类'}]}]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item label="土地用途" v-bind="formItemLayout">
                  <a-select
                    ...
                    :filterOption="filterOption"
                    notFoundContent="没有查询到数据"
                    v-decorator="['landuse', {rules: [{required: true, whitespace: true, message: '请选择土地用途'}]}]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
...
export default {
  ...
  methods: {
              ...
              res => {
                this.DE_Loding(loadingName).then(() => {
                  if (res.data.code === "0") {
                    ...
                    this.$router.push({ path: '/buildingDict', query: {showKey: 'land', refresh: true}});
                  } else {
    ...
    queryLandType() {
      ...
      this.$api.assets.getList(data).then(res => {
        if (res.data.code === "0") {
          let data = res.data.data;
