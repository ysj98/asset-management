          ...
          <div class="form-content">
            <a-row>
              ...
              <a-col :span="8">
                <a-form-model-item label="设备设施名称" prop="equipmentInstName">
                  <a-input :style="allWidth" :maxLength="64" placeholder="请输入设备设施名称" v-model="formInfo.equipmentInstName" />
                </a-form-model-item>
              </a-col>
            </a-row>
            <a-row>
              <a-col :span="8">
                <a-form-model-item label="设备设施编码" :required="true" prop="equipmentInstCode">
                  <a-input :style="allWidth" :maxLength="64" placeholder="请输入设备设施编码" v-model="formInfo.equipmentInstCode" />
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
              ...
              <a-col :span="8">
                <a-form-model-item label="规格型号">
                  <a-input :style="allWidth" :maxLength="64" placeholder="请输入规格型号" v-model="formInfo.equipmentInstModel" />
                </a-form-model-item>
              </a-col>
            </a-row>
            <a-row>
              <a-col :span="16" style="display: flex">
                <div style="width: 10.7%; text-align: right; line-height: 40px; padding-right: 10px; font-size: 12px; color: rgba(0, 0, 0, 0.85)">
                  地理位置:
                </div>
                <div style="width: 89.3%">
                  ...
                  />
                  <a-input style="width: 53.7%" :maxLength="64" placeholder="请输入详细地址" v-model="formInfo.position" />
                </div>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="品牌">
                  <a-input :style="allWidth" :maxLength="64" placeholder="请输入品牌" v-model="formInfo.equipmentInstBrand" />
                </a-form-model-item>
              </a-col>
            </a-row>
            <a-row>
              ...
              <a-col :span="8">
                <a-form-model-item label="生产厂家">
                  <a-input :style="allWidth" style="width: 55.5%" :maxLength="64" placeholder="请输入生产厂家" v-model="formInfo.equipmentFactory" />
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="出厂日期">
                  <a-date-picker :style="allWidth" valueFormat="YYYYMMDD" placeholder="请选择出厂日期" v-model="formInfo.factoryDate" />
                </a-form-model-item>
              </a-col>
            </a-row>
            <a-row>
              <a-col :span="8">
                <a-form-model-item label="报废日期">
                  <a-date-picker :style="allWidth" valueFormat="YYYYMMDD" placeholder="请选择报废日期" v-model="formInfo.expDate" />
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="安装日期">
                  <a-date-picker :style="allWidth" valueFormat="YYYYMMDD" placeholder="请选择安装日期" v-model="formInfo.installDate" />
                </a-form-model-item>
              </a-col>
            </a-row>
            <a-row>
              <a-col :span="24" style="display: flex">
                ...
                <div style="width: 86%">
                  <a-textarea :maxLength="512" placeholder="请输入备注" v-model="formInfo.equipmentInstDesc" />
                </div>
              </a-col>
            </a-row>
            <div class="mb30">
            ...
            <a-row>
              <a-col :span="24" style="display: flex">
                ...
                <div style="width: 86%">
                  <SG-UploadFile :customUpload="customUpload" v-model="formInfo.imgPath" :max="10" :maxSize="2048">
            ...
            <a-row>
              <a-col :span="24" style="display: flex">
                ...
                <div style="width: 86%">
                  <SG-UploadFile type="all" :max="5" :customUpload="customUpload" v-model="formInfo.documentPath" :maxSize="2048">
              ...
              <template v-for="item of formInfo.attrList">
                <a-col :span="8" :key="item.attrId">
                  <a-form-item :label="item.attrName">
                    <a-input :style="allWidth" :maxLength="30" :placeholder="'请输入' + item.attrName" v-model="item.attrValue" />
                  </a-form-item>
                </a-col>
              </template>
            </a-row>
  ...
  methods: {
    ...
    async changeTree(value) {
      if (value) {
        ...
        if (this.routeQuery.type !== 'edit') {
          this.formInfo.communityId = this.formInfo.equipmentId = undefined;
        }
        // 清除数据
        this.formInfo.equipmentName = this.formInfo.equipmentAreaName = this.formInfo.equipmentAreaId = this.formInfo.equipmentSupplierId = undefined;
      }
    },
    // 选择项目变化
    handleCommunityIdChange() {
      this.formInfo.equipmentAreaName = this.formInfo.equipmentAreaId = this.formInfo.equipmentSupplierId = undefined;
      this.$nextTick(() => {
