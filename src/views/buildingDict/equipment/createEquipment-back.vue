              ...
              <a-col :span="8">
                <a-form-item label="设备设施名称" v-bind="formItemLayout">
                  <a-input
                    ...
                    v-decorator="[
                      'equipmentInstName',
                      { initialValue: '' || undefined, rules: [{ required: true, whitespace: true, message: '请输入设备设施名称' }] },
                    ]"
                  />
                </a-form-item>
              </a-col>
            ...
            <a-row>
              <a-col :span="16">
                <a-form-item label="所在位置" v-bind="formItemLayoutGeo">
                  ...
                  <!--                    style="width: 28.5%;margin-right: 2%;"-->
                  <!--                    v-decorator="['equipmentAreaId']"/>-->
                  <a-input style="width: 55.5%" :maxLength="100" placeholder="请输入详细地址" v-decorator="['position']" />
                </a-form-item>
              </a-col>
              <a-col :span="8">
            ...
            <a-row>
              <a-col :span="24">
                ...
                <a-form-item label="备注" v-bind="formItemLayout2">
                  <a-textarea :maxLength="200" v-decorator="['equipmentInstDesc', { initialValue: '' || undefined }]" />
                </a-form-item>
              </a-col>
            </a-row>
            <div class="mb30">
            ...
            <a-row>
              <a-col :span="24">
                <a-form-item label="图片" v-bind="formItemLayout2">
                  <SG-UploadFile :customUpload="customUpload" v-model="formInfo.imgPath" :max="10" />
                </a-form-item>
              </a-col>
            </a-row>
            <a-row>
              <a-col :span="24">
                <a-form-item label="附件" v-bind="formItemLayout2">
                  <SG-UploadFile type="all" :max="20" :customUpload="customUpload" v-model="formInfo.documentPath" />
                </a-form-item>
              </a-col>
            </a-row>
            <div class="mb30">
...
export default {
  ...
  methods: {
    ...
    afterEquipmentApiDetail(data) {
      ...
      // 转换附件
      this.formInfo.documentPath = fileList
        .filter((item) => Number(item.fileType) === 2)
        .map((item) => ({ url: item.filePath, name: item.fileName }));
      // 合并数据
