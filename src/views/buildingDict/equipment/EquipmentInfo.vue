        ...
        <div class="top-search-one" style="padding: 0">
          ...
          <div style="overflow: visible; margin-top: -10px">
            ...
            <a-select
              ...
              notFoundContent="没有查询到数据"
            />
            <a-input :maxLength="30" placeholder="设备设施名称/编码" v-model="queryCondition.equipmentInstNameOrCode" :style="allStyle" />
...
import { operationTypes, allStyle, columns, queryCondition, communityIdOpt, parkTypeOpt, timeStampToFormatDate, registerList } from './dict.js';
