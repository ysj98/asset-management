              ...
              <a-col :span="8">
                <a-form-item label="车位数量" v-bind="formItemLayout">
                  <a-input-number
                    ...
                    v-decorator="[
                      'placeNums',
                      { rules: [{ required: true, pattern: new RegExp(/^[0-9]\d*$/, 'g'), message: '请输入车位数量,并且是正整数' }] },
                    ]"
                  />
                </a-form-item>
              </a-col>
            ...
            <a-row>
              <a-col :span="24">
                ...
                <a-form-item label="备注" v-bind="formItemLayout2">
                  <a-textarea :maxLength="128" v-decorator="['description', { initialValue: '' }]" />
                </a-form-item>
              </a-col>
            </a-row>
            <a-row>
              <a-col :span="24">
                <a-form-item label="图片" v-bind="formItemLayout2">
                  <SG-UploadFile :customDownload="customDownload" :customUpload="customUpload" v-model="formInfo.otherImg" :max="1" />
                </a-form-item>
              </a-col>
            </a-row>
          </div>
                      ...
                      <div :key="com.dataIndex">
                        <a-form-item style="margin: -5px">
                          <a-input
                            ...
                            v-decorator="[
                              `areaArray[${index}].${formInfo.areaArray[index].key + com.dataIndex}`,
                          ...
                          <span v-else-if="com.dataIndex === 'operation'" @click="handleTableDelete(index)" style="color: red; cursor: pointer"
                            >删除</span
                          >
                        </a-form-item>
                      </div>
...
export default {
  ...
  methods: {
    ...
    async afterParkApiDetail(value) {
      ...
      data.areaArray = value.areaArray.map((item) => ({
        ...item,
        key: Math.random(),
      ...
      this.formInfo.otherImg = (value.otherImg || '')
        .split(',')
        .filter((item) => item)
        .map((item) => ({ url: item, name: item.split('/').pop() }));
