...
export const carTypeOptions = [{ label: '全部车位类型', value: '' }];
export const communityIdOpt = [{ label: '全部运营项目', value: '' }];
export const parkTypeOpt = [{ label: '全部车场', value: '' }];
export const registerList = [
  { label: '是否登记资产', value: '' },
  { label: '是', value: '1' },
  { label: '否', value: '0' },
];
export const carStatusOpt = [{ label: '全部状态', value: '' }];
export const parkAreaOpt = [{ label: '全部区域', value: '' }];
