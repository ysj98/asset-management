      ...
      <div slot="headerForm" class="search-content-box">
        <div class="top-search-one" style="padding: 0">
          <div>
            ...
            <SG-Button v-if="hasPowerExport && false" @click="exportList" class="mr10">
          ...
          <div style="overflow: visible; margin-top: -10px">
            ...
            />
            <!-- 资产名称或编码 -->
            <a-input :maxLength="30" placeholder="车位名称/编码" v-model="queryCondition.parkingPlaceStr" :style="allStyle" />
...
export default {
  ...
  watch: {
    $route() {
      if (this.$route.path === '/buildingDict' && this.$route.query.refresh && this.$route.query.showKey === 'stall') {
