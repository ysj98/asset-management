...
export default {
  ...
  data: ()=>({
    color: '',
    colorList: [
      '#CC00CC','#CC0099','#CC0066','#CC0033','#CC0000','#CC3300','#CC6600','#CC9900',
      '#CCCC00','#99CC00','#66CC00','#33CC00','#00CC00','#00CC33','#00CC66','#00CC99',
      '#00CCCC','#0099CC','#0066CC','#0033CC','#0000CC','#3300CC','#6600CC','#9900CC',
    ]
  }),
  methods: {
    handleSubmit () {
