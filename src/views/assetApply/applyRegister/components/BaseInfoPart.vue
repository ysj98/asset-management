      ...
      <a-row :gutter="24">
        ...
        <a-col :span="8">
          <a-form-item :label-col="formItemLayout.labelCol" :wrapper-col="formItemLayout.wrapperCol" label="领用部门">
            <treeSelect
              @changeTree="setData(arguments, 'receiveOrganName')"
              placeholder="请选择领用部门"
              :allowClear="false"
              style="width: 100%"
        ...
        <a-col :span="8">
          <a-form-item :label-col="formItemLayout.labelCol" :wrapper-col="formItemLayout.wrapperCol" label="领用人">
            <a-select
              ...
              @search="handleSearchReceiveUserList"
              placeholder="请选择领用人"
...
export default {
  ...
  methods: {
    ...
    renderDetail() {
      ...
      let formatDetails =
        type != 'add'
          ? {
              receiveName,
              receiveDate: moment(receiveDate || new Date(), 'YYYY-MM-DD'),
              returnDate: returnDate ? moment(returnDate, 'YYYY-MM-DD') : '',
            }
          : { receiveName, receiveDate: moment(receiveDate || new Date(), 'YYYY-MM-DD') };
    ...
    // 搜索 领用人列表
    handleSearchReceiveUserList(value) {
      this.queryStaff(this.receiveUserId, value);
    },
