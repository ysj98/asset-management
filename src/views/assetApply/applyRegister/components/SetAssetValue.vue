  ...
  <div>
    ...
    <a-row v-if="isShowMethod" style="margin-bottom: 24px">
      <a-col :span="24">
        ...
        <a-radio-group v-model="methodValue">
          <div>
          ...
          <div style="margin-top: 16px">
            ...
            <span style="display: inline-block; width: 400px; color: #bfbfbf"
              >*说明：估值总金额为100万，资产1面积10㎡，资产02面积30㎡，则资产1估值25万，资产2估值75万</span
            >
          </div>
        </a-radio-group>
      </a-col>
...
export default {
  ...
  data() {
    return {
      ...
      typeOptions: [
        { title: '单个资产估值', value: '2' },
        { title: '所选资产总估值', value: '1' },
      ], // 估值类型选项
    };
  },
