    ...
    <SG-SearchContainer size="fold" background="white" v-model="toggle" @input="searchContainerFn">
      <div slot="headBtns">
        <div class="box" style="margin-left: 16px">
          <SG-Button type="primary" v-power="ASSET_MANAGEMENT.ASSET_APPLY_VIEW_EXPORT" @click="exportFn"
    ...
    <div class="table-layout-fixed">
      ...
      <a-table :loading="loading" :columns="columns" :dataSource="tableData" size="middle" :pagination="false">
        <template slot="operation" slot-scope="text, record">
          <div class="opt">
            <router-link
              :to="{ name: '资产领用一览表详情', params: { registerId: record.receiveDetailId, type: 'detail', organId, organName } }"
              class="action_text"
              >详情</router-link
            >
          </div>
