      ...
      <a-row :gutter="24">
        ...
        <a-col :span="8">
          <a-form-item :label-col="formItemLayout.labelCol" :wrapper-col="formItemLayout.wrapperCol" label="所属组织机构">
            <a-input v-decorator="['organName']" disabled></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="8">
      ...
      <a-row :gutter="24">
        <a-col :span="8">
          <a-form-item :label-col="formItemLayout.labelCol" :wrapper-col="formItemLayout.wrapperCol" label="资产类型">
            <a-input style="width: 100%" v-decorator="['assetTypeName']" disabled></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="8">
    ...
    renderDetail() {
      ...
      if (type === 'approval' || type === 'detail') {
        formatDetails = Object.assign({}, formatDetails, {
          ...
          returnDate: moment(returnDate || new Date(), 'YYYY-MM-DD'),
        });
      } else {
        formatDetails = Object.assign({}, formatDetails, {
          remark: remark || '',
