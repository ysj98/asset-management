...
<template>
  <div class="worth_list">
    ...
    <div style="margin-left: 40px">
      ...
      <a-table v-bind="tableObj" class="custom-tables" bordered>
...
export default {
    ...
    return {
      tableObj: {
        ...
        columns: [
          ...
          { title: '归还面积（m²）', dataIndex: 'returnArea' },
  ...
  watch: {
    details: function () {
      if (
        this.details.assetInfo.assetTypeName == '房屋' ||
        this.details.assetInfo.assetTypeName == '土地' ||
        this.details.assetInfo.assetTypeName == '车场'
      ) {
        this.isShow = true;
      }
      this.numList.map((item, index) => {
