  ...
  export default {
      ...
      return {
        tableObj: {
          ...
          columns: [
            ...
            { title: '归还面积（m²）', dataIndex: 'returnArea' },{ title: '归还部门', dataIndex: 'returnOrganName' },
    ...
    methods: {
      ...
      queryAssetListByRegisterId ({pageNo = 1, pageLength = 10, type}) {
        ...
        if (!details.returnList) { return this.$message.info('无归还记录') }
        this.tableObj.loading = true
          this.tableObj.loading = false
            ...
            this.numList[index].value = this.details.receiveDetail[item.key]
          })
            return false
