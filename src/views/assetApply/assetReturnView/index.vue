  ...
  <div class="assetRegister">
    ...
    <SG-SearchContainer size="fold" background="white" v-model="toggle" @input="searchContainerFn">
      ...
      <div slot="form" class="formCon">
        ...
        <div class="box">
            <a-input placeholder="归还单编号" v-model="queryCondition.returnName" :max-Length="30"></a-input>
            <a-input placeholder="领用单编号" v-model="queryCondition.receiveName" class="box-right" :max-Length="30"></a-input>
        </div>
      </div>
    </SG-SearchContainer>
    </keep-alive>
    ...
    <div class="table-layout-fixed">
      ...
      <a-table
        ...
        <template slot="returnDetailId" slot-scope="text, record">
          <div class="opt">
          <router-link :to="{name: '资产归还一览表详情', params: {registerId: record.returnDetailId, type: 'detail', organId, organName}}" class="action_text">{{record.returnDetailId}}</router-link>
          </div>
        </template>
      </a-table>
    </div>
