...
<template>
  <div class="landInfo-page pb70">
      ...
      <div slot="headerForm" class="search-content-box">
        <div class="top-search-one" style="padding: 0">
          ...
          <div style="overflow: visible; margin-right: 10px; margin-top: 0px">
            ...
            />
            <dict-select style="width: 170px; margin-left: 10px; margin-top: -10px" :dict-options="statusOptions" v-model="queryCondition.status" />
    ...
    <append-dialog :organObject="organObject" :object="selectItem" :visible="appendVisible" @submit="handleAppendSubmit" @close="handleAppendClose" />
  </div>
</template>
<script>
...
import { columns, queryCondition, statusOptions } from './dict.js';
