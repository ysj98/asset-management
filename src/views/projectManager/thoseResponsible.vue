...
-->
<template>
  <a-modal class="thoseResponsible" :title="title" :visible="visible" width="800px" :footer="null" @ok="handleOk" @cancel="handleCancel">
    <SG-Title title="基本信息" />
    <div>
      <a-row>
        <a-col :span="12"> 资产项目名称：{{ basicInformation.projectName || '--' }} </a-col>
        <a-col :span="12"> 所属上级机构: {{ basicInformation.organName || '--' }} </a-col>
        <a-col class="mt20" :span="12"> 资产项目编码：{{ basicInformation.projectCode || '--' }} </a-col>
      </a-row>
    </div>
