...
<template>
  <div class="projectManager">
    ...
    <search-container v-model="fold">
      <div slot="headerBtns">
        <SG-Button icon="export" @click="handleImport" :loading="importBtnLoading">批量导入</SG-Button>
        <SG-Button class="ml10" icon="export" @click="downExport" :loading="downBtnLoading">模板下载</SG-Button>
        <SG-Button class="ml10" icon="export" @click="handleExport" :loading="exportBtnLoading">批量导出</SG-Button>
      </div>
...
export default {
  ...
  methods: {
    ...
    uploadFile(file) {
      ...
      this.$api.projectManager
        .importProjectResponsibility(fileData, organId)
        .then((r) => {
