    ...
    <SG-SearchContainer size="fold" background="white" v-model="toggle" @input="searchContainerFn">
      <div slot="headBtns">
        ...
        <SG-Button
          ...
          v-power="ASSET_MANAGEMENT.ASSET_ENTRY_EXPORT"
          >导出</SG-Button
        >
        <SG-Button icon="plus" type="primary" style="margin-right: 8px" @click="newAssetEntry" v-power="ASSET_MANAGEMENT.ASSET_ENTRY_NEW"
          >新建卡片</SG-Button
        >
        <SG-Button
          type="primary"
          ...
          @click="batchSubmit"
          v-power="ASSET_MANAGEMENT.ASSET_ENTRY_BATCH_SUBMISSION"
          >批量提交</SG-Button
        >
        <!-- 暂时不用 -->
      ...
      >
        ...
        <template slot="operation" slot-scope="text, record">
          <a
            ...
            v-power="ASSET_MANAGEMENT.ASSET_ENTRY_AUDIT"
            >审核</a
          >
          <a
            class="operation-btn"
            ...
            v-power="ASSET_MANAGEMENT.ASSET_ENTRY_REVERSE_AUDIT"
            >反审核</a
          >
          <a
            class="operation-btn"
            ...
            v-power="ASSET_MANAGEMENT.ASSET_ENTRY_EDIT"
            >编辑</a
          >
          <a
            class="operation-btn"
            ...
            v-power="ASSET_MANAGEMENT.ASSET_ENTRY_DELETE"
            >删除</a
          >
...
export default {
  ...
  methods: {
    ...
    batchSubmit() {
      ...
      this.$api.assets
        .batchSubmission({ cardIdList: this.selectedRowKeys })
        .then((res) => {
          if (res.data.code === '0') {
    ...
    handleOperation(pageType, record) {
      this.$router.push({
        path: '/assetEntry/' + pageType,
        query: { pageType: pageType, cardId: record.cardId, organId: record.organId, organName: record.organName },
      });
    },
    // 点击查询
    queryClick() {
    ...
    uploadFile(file) {
      ...
      this.$api.tableManage
        .importAssetCardData(query, fileData)
        .then((r) => {
