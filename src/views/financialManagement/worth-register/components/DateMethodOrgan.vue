...
export default {
  ...
  created() {
    ...
    this.defaultValue = [value.beginDate ? moment(value.beginDate, 'YYYY-MM-DD') : null, value.endDate ? moment(value.endDate, 'YYYY-MM-DD') : null];
    // this.queryDict()
  },
  ...
  watch: {
    ...
    assessmentOrgan: function (assessmentOrgan) {
      ...
      this.$emit('input', {
        assessmentOrgan: this.assessmentOrgan,
        beginDate,
        endDate,
        beginAssessmenBaseDate,
        endAssessmenBaseDate,
        assessmentMethod,
      });
    },
