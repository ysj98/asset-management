<template>
  <div class="detail">
    ...
    <div class="table-layout-fixed">
      <a-table :loading="loading" :columns="tableInfo.columns" :dataSource="tableInfo.tableData" size="middle" :pagination="false"> </a-table>
...
export default {
  ...
  methods: {
    ...
    getDispOrgStatProDetail() {
      ...
      // }
      this.$api.disposalManagement.getDispOrgStatProDetail(this.queryInfo).then(
        (res) => {
          if (Number(res.data.code) === 0) {
