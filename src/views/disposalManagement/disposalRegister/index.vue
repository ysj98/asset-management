  ...
  <div class="scheduleChanges pb70">
    <SearchContainer v-model="toggle" @input="searchContainerFn" :contentStyle="{ paddingTop: toggle ? '16px' : 0 }">
      <div slot="headerBtns">
        ...
        <SG-Button v-power="ASSET_MANAGEMENT.zcgl_dengji_create" icon="plus" @click="goPage('create')" type="primary"> 新增处置登记 </SG-Button>
      </div>
      <div slot="headerForm" style="float: right; text-align: left">
        ...
        ></treeSelect>
        <a-input-search
          v-model="queryCondition.disposeName"
          placeholder="资产处置名称"
          :maxLength="30"
      ...
      <div slot="contentForm" class="search-content-box">
        <div class="search-from-box">
          ...
          <a-select
            ...
            :maxTagCount="1"
            :style="allStyle"
            :options="$addTitle(disposeTypeOpt)"
            :allowClear="false"
            :filterOption="filterOption"
            notFoundContent="没有查询到数据"
          />
          ...
          <a-select
            ...
            :maxTagCount="1"
            :style="allStyle"
            :options="$addTitle(disposeModeOpt)"
            :allowClear="false"
            :filterOption="filterOption"
            notFoundContent="没有查询到数据"
          />
