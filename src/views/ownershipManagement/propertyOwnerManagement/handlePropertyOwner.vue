...
-->
<template>
  <SG-Modal class="handlePropertyOwner" :width="modal.width" v-model="modal.show" :title="modal.title" @ok="handleSubmit" @cancel="handleCancel">
    <div slot="footer" v-show="editable">
      <SG-Button key="submit" type="primary" @click="handleSubmit"> 提交 </SG-Button>
      <SG-Button key="back" @click="handleCancel"> 取消 </SG-Button>
    </div>
        ...
        <div class="edit-box-content">
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box" :class="{ required: editable }">
              <span class="label-name" :class="{ 'label-space-between': editable }">本企业所属人<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-radio-group
                option.initialValue="detail.currentOrgan"
                v-if="editable"
                v-decorator="['currentOrgan', { rules: [], initialValue: detail.currentOrgan }]"
              >
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box" :class="{ required: editable }">
              <span class="label-name" :class="{ 'label-space-between': editable }">权属人名称<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
                ...
                v-decorator="[
                  'obligeeName',
                  {
                    rules: [{ required: true, max: 50, whitespace: true, message: '请输入权属人名称(长度最多为50)' }],
                    initialValue: detail.obligeeName,
                  },
                ]"
              />
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box" :class="{ required: editable }">
              <span class="label-name" :class="{ 'label-space-between': editable }">权属人类型<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-select
                showSearch
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box" :class="{ required: editable }">
              <span class="label-name" :class="{ 'label-space-between': editable }">证件类型<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-select
                showSearch
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box" :class="{ required: editable }">
              <span class="label-name" :class="{ 'label-space-between': editable }">证件号码<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
                placeholder="请输入证件号码"
                ...
                v-decorator="[
                  ...
                  {
                    rules: [
                      { required: true, max: 40, whitespace: true, message: '请输入证件号码(长度最多为40)' },
                      { validator: validateCertificateNo },
                    ],
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">通讯地址<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
                placeholder="请输入通讯地址"
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">邮编<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
                placeholder="请输入邮编"
                ...
                v-decorator="[
                  'postalCode',
                  {
                    rules: [{ max: 100, whitespace: true, message: '邮编长度最多为100' }, { validator: validatePostalCode }],
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">法定代表<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
                placeholder="请输入法定代表"
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">联系方式(法)<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
                ...
                v-decorator="[
                  'legalAgentTel',
                  {
                    rules: [{ max: 30, whitespace: true, message: '联系方式长度最多为30' }, { validator: validateTel }],
                    initialValue: detail.legalAgentTel,
                  },
                ]"
              />
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">代理人(机构)<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">联系方式(代)<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
          ...
          <div class="edit-box-content-item" v-if="checkNick">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">AppID<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
          ...
          <div class="edit-box-content-item" v-if="checkNick">
            <div class="label-name-box">
              <span class="label-name" :class="{ 'label-space-between': editable }">秘钥<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
                placeholder="请输入秘钥"
