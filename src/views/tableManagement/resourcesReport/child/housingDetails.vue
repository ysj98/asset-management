...
-->
<template>
  <SG-Modal width="1030px" v-model="status" title="房屋详情" :footer="null" :noPadding="true" @cancel="cancel">
    ...
    <div class="housingDetails m15">
      ...
      <div class="tab-nav">
        <div class="table-border table-layout-fixed">
          <a-table :scroll="{ y: 450, x: 800 }" :loading="loading" :columns="columns" :dataSource="tableData" size="middle" :pagination="false">
          </a-table>
