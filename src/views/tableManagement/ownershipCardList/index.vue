      ...
      return {
        ...
        tableObj: {
          ...
          columns: [
            ...
            { title: '权属人/承租人', dataIndex: 'obligeeName' },
            { title: '被委托管理单位', dataIndex: 'entrustOrganization' },
            { title: '房屋号/丘地号/不动产单元号', dataIndex: 'lotNo', scopedSlots: { customRender: 'lotNo' } },
            ...
            { title: '使用权合同期限', dataIndex: 'contractData' },
