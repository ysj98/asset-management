...
<template>
  <div class="list_part">
    ...
    <div style="margin-left: 45px">
      ...
      <a-table :columns="columns" :dataSource="dataSource" bordered size="middle" :pagination="false" :loading="tableLoading" :scroll="tableScroll">
  ...
  methods: {
    ...
    async queryTableData({ pageNo = 1, pageLength = 10 }) {
      ...
      this.$api.tableManage
        .queryAssetHouseList({ ...queryInfo, dimension, pageSize: pageLength, pageNum: pageNo, organQueryType: this.organQueryType })
        .then((r) => {
