  ...
  <div class="barcodeManagement">
    <search-container size="fold" v-model="fold">
      <div slot="headerBtns">
        ...
        <SG-Button v-power="ASSET_MANAGEMENT.BARCODE_MANAGEMENT_EXPORT" style="margin-left: 15px" @click="exportLabel"
    ...
    <labelcodeDataImport
      ref="labelcodeDataImport"
      :projectData="projectData"
      :labelTemp="labelTemp"
      @success="query"
      @hiddeModal="cancelDataImport"
    ></labelcodeDataImport>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    exportLabel() {
      ...
      this.$api.barCode.exportLabelData(form).then(
        (res) => {
