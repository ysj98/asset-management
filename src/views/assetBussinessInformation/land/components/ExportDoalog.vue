<template>
  <div>
    <a-modal title="导出" :visible="visible" width="800px" okText="下载模板" @cancel="handleCancel" @ok="handleSubmit">
      <div class="box">
              ...
              <a-row>
                <a-col class="playground-col" :span="24">
                  <a-form-model-item label="经营方式：">
                    <dict-select :dictOptions="operationMode" placeholder="选择经营方式" @change="handleChange" v-model="formInfo.modeOperId" />
                  </a-form-model-item>
                </a-col>
              </a-row>
              <a-row>
