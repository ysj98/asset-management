      ...
      <div class="chargesNewEdit">
        ...
        <div class="mt15 mb15">
          <a-row class="playground-row">
            ...
            <a-col v-if="type === 'edit'" :span="12" :class="type === 'new' ? 'h-65' : 'h-40'"
              ...
              <a-col :span="12" class="h-65">
                <a-form-item label="类别" v-bind="formItemLayout">
                  <a-select
                    ...
                    v-decorator="['category', { rules: [{ required: true, message: '请选择类别' }], initialValue: subData.category }]"
                    notFoundContent="没有查询到数据"
                  />
                </a-form-item>
              </a-col>
              ...
              <a-col :span="12" class="h-65">
                <a-form-item label="所属月份" v-bind="formItemLayout">
                  <a-month-picker
                    :style="allWidth"
                    placeholder="所属月份"
                    v-decorator="['belongMonth', { rules: [{ required: true, message: '所属月份' }] }]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="12" class="h-65">
                <a-form-item label="金额(元)" v-bind="formItemLayout">
                  <a-input-number
                    ...
                    :precision="2"
                    :max="9999999.99"
                    v-decorator="['amount', { rules: [{ required: true, message: '请输入金额' }], initialValue: subData.amount }]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="12" class="h-65">
                <a-form-item label="读数" v-bind="formItemLayout">
                  <a-input-number
                    ...
                    :precision="2"
                    :max="9999999.99"
                    v-decorator="['readNum', { rules: [{ required: false, message: '请输入读数' }], initialValue: subData.readNum }]"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="24">
