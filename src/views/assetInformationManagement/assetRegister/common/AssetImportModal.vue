...
<template>
  <div class="basicDownload">
    <SG-Modal width="900px" :visible="modalData.flag" :title="modalData.title" @cancel="doClose">
      <div class="container">
        <div class="modal-left">
          ...
          >
            <SG-Button class="ml20" type="primary" weaken> 上传文件 </SG-Button>
          </a-upload>
        </div>
        <div class="modal-right">
          ...
          <div class="model-right-footer">
            <SG-Button weaken @click="commonFn"> 下载导入模板 </SG-Button>
          </div>
        </div>
      </div>
      <template #footer class="footer">
        <SG-Button :disabled="!fileList.length" class="ml20" type="primary" weaken @click="handleImport"> 导入 </SG-Button>
        <SG-Button class="ml20" type="cancel" weaken @click="doClose"> 取消 </SG-Button>
      </template>
    </SG-Modal>
  </div>
</template>
...
import { checkBuildsObjectTypeFn, commonFn, confirmDownloadTemplate } from './share';
