...
export const houseVerificationList = [
  ...
  { title: '闲置面积', dataIndex: 'idleArea', required: false, type: 'float' },
  { title: '自用面积', dataIndex: 'selfUserArea', required: false, type: 'float' },
  { title: '占用面积', dataIndex: 'occupationArea', required: false, type: 'float' },
  { title: '其他面积', dataIndex: 'otherArea', required: false, type: 'float' },
...
export const landVerificationList = [
  ...
  { title: '闲置面积', dataIndex: 'idleArea', required: false, type: 'float4' },
  { title: '自用面积', dataIndex: 'selfUserArea', required: false, type: 'float4' },
  { title: '占用面积', dataIndex: 'occupationArea', required: false, type: 'float4' },
  { title: '其他面积', dataIndex: 'otherArea', required: false, type: 'float4' },
  { title: '转物业日期', dataIndex: 'transferTime', required: false, date: true }, //  type: 'number',
  { title: '转物业面积', dataIndex: 'transferArea', required: false, type: 'float' },
  { title: '使用期限(月)', dataIndex: 'validPeriod', required: false, type: 'number' },
  { title: '开始使用日期', dataIndex: 'startDate', required: false, date: true }, // type: 'number',
