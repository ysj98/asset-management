  ...
  <div class="assetRegister">
    <SG-SearchContainer size="fold" background="white" v-model="toggle" @input="searchContainerFn">
      <div slot="headBtns">
        ...
        <SG-Button type="primary" v-power="ASSET_MANAGEMENT.ASSET_REGISTER_VIEW_EXPORT" @click="exportFn"
      ...
      <div slot="form" class="formCon">
        ...
        />
        <a-input-search
          v-model="queryCondition.originSource"
          placeholder="请输入资产原始来源方"
          :maxLength="100"
          style="width: 170px; height: 32px; margin-right: 10px"
          @search="allQuery"
        />
      </div>
    </SG-SearchContainer>
    ...
    <div class="table-layout-fixed">
      <!-- ref="table_box" -->
      <a-table :loading="loading" :scroll="scrollHeight" :columns="columns" :dataSource="tableData" size="middle" :pagination="false">
        <template slot="operation" slot-scope="text, record">
          <router-link
            :to="{
              path: '/assetCheckInView/detail',
              query: { registerOrderId: record.registerOrderId, assetId: record.assetId, assetType: record.assetType },
            }"
            class="action_text"
            >详情</router-link
          >
