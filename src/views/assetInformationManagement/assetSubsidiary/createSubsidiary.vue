...
<template>
  <a-spin :spinning="spinning">
    <div class="inventoryPlan-create">
          ...
          <div class="edit-box-content-item mr24">
            <div class="label-name-box required">
              ...
              <span class="label-value"
                >{{ selectObj.assetName || '-'
                }}<SG-Button @click="showRadioAssetModal" type="primary" icon="plus" size="small" class="ml10" weaken>选择</SG-Button></span
              >
            </div>
          </div>
          <div class="edit-box-content-item mr24">
          ...
          <a-form :form="form">
            <div class="edit-box-content">
              ...
              <span></span>
                ...
                <a-form-item>
                  <a-checkbox :checked="checkNick" @change="handleChange"> 接管前附属配套 </a-checkbox>
                </a-form-item>
              </div>
      ...
      <FormFooter v-if="['create', 'edit'].includes(type)" style="border: none" location="fixed">
