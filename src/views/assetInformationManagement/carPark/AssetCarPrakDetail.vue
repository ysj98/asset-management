<template>
  <div class="asset_view">
    ...
    <base-info-part
      ref="baseInfoPart"
      v-if="assetCarParkId"
      comType="assetCarPark"
      :assetCarParkId="assetCarParkId"
      @updateTransfer="updateTransfer"
      :baseInfoKeys="baseInfoKeys"
...
export default {
    ...
    return {
      ...
      baseInfoKeys: [
        ...
        [
          ...
          { title: '是否抵押', key: 'mortgageName' },
          { title: '涉诉情况', key: 'lawsuitRemark' },
        ], // 列2
        [
          { title: '资产编码', key: 'assetCode' },
          { title: '是否质押', key: 'pledgeName' },
  ...
  methods: {
    ...
    exportCard() {
      ...
      this.$api.assets
        .exportHouseCard({ assetCarParkId, assetId })
        .then((res) => {
  ...
  created() {
    const {
      query: { assetCarParkId, assetId, organId },
    } = this.$route;
