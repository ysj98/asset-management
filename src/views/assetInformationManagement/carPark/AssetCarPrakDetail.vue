      ...
      return {
        ...
        baseInfoKeys: [
          ...
          [
            ...
            {title: '资产状态', key: 'statusName'},{title: '是否抵押', key: 'mortgageName'}, {title: '涉诉情况', key: 'lawsuitRemark'}
          ], // 列2
          [
            {title: '资产编码', key: 'assetCode'}, {title: '是否质押', key: 'pledgeName'}, {title: '涉诉', key: 'lawsuitName'}
          ], // 列3
          // [
