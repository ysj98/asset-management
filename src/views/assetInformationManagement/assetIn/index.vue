...
<template>
  <div class="asset_in">
    ...
    <search-container v-model="fold">
      <div slot="headerBtns">
        <SG-Button icon="import" @click="newAsset" type="primary" style="margin-right: 8px" v-power="ASSET_MANAGEMENT.ASSET_IN_LIST_REGISTER"
          >入库登记</SG-Button
        >
      ...
      <div slot="headerForm" style="float: right; text-align: left">
        <tree-select @changeTree="changeTree" style="width: 240px" :showSearch="true" />
      ...
      <div slot="contentForm">
        <a-row :gutter="8">
          ...
          <a-col :span="8">
            ...
            <a-range-picker format="YYYY-MM-DD" class="date_picker_style" style="margin-left: 69px" @change="changeCreateDate" />
          </a-col>
  ...
  methods: {
    ...
    deleteAsset({ storeId, organId }) {
      ...
      _this.$confirm({
        ...
        onOk: function () {
          ...
          _this.$api.assets
            .auditAssetStore({ storeId, organId, advice: '', status: 4 })
            .then(({ data: res }) => {
              if (res && String(res.code) === '0') {
    ...
    queryTableData({ pageNo = 1, pageLength = 10, type }) {
      const {
        ...
        maxCreateDate,
        organProjectType,
        organProjectType: { assetType, projectId, organId },
      } = this;
