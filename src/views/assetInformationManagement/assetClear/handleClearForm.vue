        ...
        <div class="edit-box-content">
          <div class="edit-box-content-item">
            <div class="label-name-box" :class="{ required: editable }">
              <span class="label-name" :class="{ 'label-space-between': editable }">出库单名称<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-input
          ...
          <div class="edit-box-content-item">
            <div class="label-name-box" :class="{ required: editable }">
              <span class="label-name" :class="{ 'label-space-between': editable }">出库原因<i></i></span><span>：</span>
            </div>
            <a-form-item>
              <a-select
                showSearch
                ...
                :filterOption="filterOption"
                v-decorator="['cleanupType', { rules: [{ required: true, message: '请选择出库原因' }], initialValue: detail.cleanupType }]"
                v-if="editable"
              ></a-select>
          ...
          <div class="edit-box-content-item" v-show="!editable">
            <div class="label-name-box">
              <span class="label-name">备注<i></i></span><span>：</span>
            </div>
            <a-form-item>
