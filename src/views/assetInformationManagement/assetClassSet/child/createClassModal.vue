            ...
            <div class="edit-box-content-item">
              ...
              <a-form-item>
                <a-select
                  ...
                  v-decorator="['unit', { initialValue: detail.unit }]"
                ></a-select>
            ...
            <div class="edit-box-content-item">
              ...
              <a-form-item>
                <a-input-number
                  ...
                  step="1"
                  v-if="editable"
                  v-decorator="['netSalvageRate', { rules: [validateRate], initialValue: detail.netSalvageRate }]"
                />
            ...
            <div class="edit-box-content-item">
              ...
              <a-form-item>
                <a-input-number
                  ...
                  :min="0"
                  :precision="0"
                  v-decorator="['usedAge', { initialValue: detail.usedAge }]"
                />
            ...
            <div class="edit-box-content-item">
              ...
              <a-form-item>
                <a-input-number
                  ...
                  :precision="0"
                  v-if="editable"
                  v-decorator="['depreciationAge', { initialValue: detail.depreciationAge }]"
                />
